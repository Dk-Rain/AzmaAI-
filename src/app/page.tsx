    ...
    >
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <main className="flex-1">
          ...
          <section className="w-full py-20 md:py-32 lg:py-40">
            <div className="container px-4 md:px-6 text-center">
              <div className="max-w-3xl mx-auto space-y-4">
                <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl font-headline text-white">
                  From Topic to write Smarter with AzmaAI
                </h1>
                ...
                <div className="flex flex-col gap-2 min-[400px]:flex-row justify-center">
                  ...
                  <Link
                    href="#"
                    className="inline-flex h-12 items-center justify-center rounded-md border border-input bg-background/50 px-8 text-sm font-medium shadow-sm transition-colors hover:bg-accent hover:text-accent-foreground text-white"
                    prefetch={false}
                  >
          ...
          <section id="features" className="w-full py-12 md:py-24 lg:py-32 bg-background/90">
            <div className="container px-4 md:px-6">
              <div className="text-center space-y-3 mb-12">
          ...
          {/* Pricing Section */}
          <section id="pricing" className="w-full py-12 md:py-24 lg:py-32 bg-background/90">
            <div className="container px-4 md:px-6">
               <div className="text-center space-y-3 mb-12">
